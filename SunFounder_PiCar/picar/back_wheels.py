...
class Back_Wheels(object):
    ...
    #Set Speedleft and speedRight in Class
        self._speedLeft = 0
        self._speedRight = 0
        self._speed = 0
    ...
    def speedLeft(self, speedLeft):
        ...
        ''' Set moving speeds '''
        self.left_wheel.speed = self._speedLeft
        self._debug_('Set speed to %s' % self._speedLeft)
        
    @property
    def speedRight(self, speedRight):
    ...
    def speedRight(self, speedRight):
        ...
        ''' Set moving speeds '''
        self.right_wheel.speed = self._speedRight
        self._debug_('Set speed to %s' % self._speedRight)
